    ...
    <div className="max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {courses.map((course, index) => (
          <motion.div
            key={index}
            className="p-6 bg-white rounded-lg shadow-md cursor-pointer hover:shadow-2xl transition"
          ...
          >
            ...
            <button className="mt-4 px-5 py-2 bg-green-700 text-white rounded-lg font-medium hover:bg-green-800 active:scale-95 transition-transform">
              Learn More
            </button>
          </motion.div>
        ))}
